...
function drawScoreboard() {
	...
	if (gameState === 0) {
		...
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2.1 + gdy - 155 * settings.scale, 150, "#2c3e50", "GENIEUSES");
		renderText(trueCanvas.width / 2 + gdx + 5 * settings.scale, h + 10, fontSize, "rgb(44,62,80)", 'Play!');
	} else if (gameState != 0 && textOpacity > 0) {
		textOpacity -= 0.05;
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy, 60, "rgb(236, 240, 241)", String.fromCharCode("0xf04b"), 'px FontAwesome');
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 155 * settings.scale, 150, "#2c3e50", "GENIEUSES");
...
function showText(text) {
	var messages = {
		'paused': "<div class='centeredHeader unselectable'>Break</div>",
		'pausedAndroid': "<div class='centeredHeader unselectable'>Break</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'></div>",
		'pausediOS': "<div class='centeredHeader unselectable'>Break</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:30margin-left:-190px;max-width:380px;font-size:18px;'></div>",
		'pausedOther': "<div class='centeredHeader unselectable'>Break</div><div class='unselectable centeredSubHeader' style='margin-top:10px;position:absolute;left:50%;</div>",
